      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Kesenian Kebudayaan</h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/C_login/seni_proses') ?>">
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Tarian</label>
                              <div class="col-sm-10">
                                  <select class="form-control" name="tarian">
                                    <option>Soya-soya</option>
                                    <option>Kapita</option>
                                    <option>Cakalele</option>
                                    <option>Dana-dana</option>
                                  </select>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Alat Musik</label>
                              <div class="col-sm-10">
                                  <select class="form-control" name="musik">
                                    <option>Tifa</option>
                                    <option>Rababu</option>
