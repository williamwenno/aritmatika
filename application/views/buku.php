      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Buku Perpustakaan</h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/C_login/buku_proses') ?>">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Spesifik Asal</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="spesifik_asal">
                              </div>
                          </div>
