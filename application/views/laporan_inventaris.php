      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<div class="row"><div class="col-sm-8"><h3><i class="fa fa-angle-right"></i> Welcome</h3></div><div class="col-sm-4 text-right"><?php echo date('d/m/Y') ?></div></div>
          	<div class="row mt">
          		<div class="col-lg-12">
          		<div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Laporan Inventaris</h4>
                      <?php echo form_open_multipart('c_login/laporan_inventaris_proses');?>
                      <div class="form-horizontal style-form">
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pilih Jenis Inventaris</label>
                              <div class="col-sm-10">
                                 <select class="form-control" name="jenis">
                                    <option>-- Pilih Jenis Invetaris --</option>
                                     <option value="buku_perpustakaan">Buku Perpustakaan</option>
                                     <option value="gedung_bangunan">Gedung Bangunan</option>
                                     <option value="hewan_ternak_tumbuhan">Hewan Ternak & Tumbuhan</option>
                                     <option value="kesenian_kebudayaan">Kesenian & Kebudayaan</option>
                                     <option value="peralatan_mesin">Peralatan Mesin</option>
                                    <option value="aset_tetap_lain">Aset Tetap Lain</option>
                                 </select>
                              </div>
                          </div>
