      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Gedung Bangunan</h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/C_login/gedung_proses') ?>">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kondisi Bangunan</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="kondisi_bangunan">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Konstruksi Bangunan</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="konstruksi_bangunan">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Luas Lantai</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="luas_lantai">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Letak Lokasi</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="letak_lokasi">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Dokumen Gedung</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="dokumen_gedung">
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Status Tanah</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tahun Perolehan</label>
                              <div class="col-sm-10">
