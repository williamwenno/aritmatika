      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Hewan Ternak Tumbuhan  </h4>
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/C_login/hewan_proses') ?>">
